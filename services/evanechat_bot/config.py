...
AI_CHATTER_GATEWAY_HOST = os.getenv("AI_CHATTER_GATEWAY_HOST", "127.0.0.1")
AI_CHATTER_GATEWAY_PORT = int(os.getenv("AI_CHATTER_GATEWAY_PORT", "8091"))
AI_CHATTER_GATEWAY_SECRET = os.getenv("AI_CHATTER_GATEWAY_SECRET", "")
AI_CHATTER_AIO_EVENT_URL = os.getenv(
    "AI_CHATTER_AIO_EVENT_URL",
    "http://127.0.0.1:8000/api/internal/aichatter/dialog-start",
)
AI_CHATTER_DIRECT_BOT_TOKEN = os.getenv("AI_CHATTER_DIRECT_BOT_TOKEN", "")
